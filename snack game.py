...
# class Food:
#     def __init__(self):
#         self.pos = (random.randint(0, SCREEN_WIDTH // BLOCK_SIZE - 1), random.randint(0, SCREEN_HEIGHT // BLOCK_SIZE - 1))
...
#     if snake.segments[0] == food.pos:
#         food = Food()
#         snake.segments.append(snake.segments[-1])
#         score += 1
    
#     # Check if the Snake has collided with the walls or itself
#     if snake.segments[0][0] < 0 or snake.segments[0][0] >= SCREEN_WIDTH // BLOCK_SIZE or snake.segments[0][1] < 0 or snake.segments[0][1] >= SCREEN_HEIGHT // BLOCK_SIZE:
#         running = False
...
def main(win, width):
    ...
    # تحديد نقة البداية والنهاية تلقائيًا
    start = grid[0][0]
    start.make_start()
